...
public class RegisterReceipient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_receipient);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dataBaseAdapter.insertRecipient(valuesmap);
